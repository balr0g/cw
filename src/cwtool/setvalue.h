...
extern int				setvalue_uint(unsigned int *, unsigned int, unsigned int, unsigned int);
extern int				setvalue_int(int *, int, int, int);
extern int				setvalue_uint_bit(unsigned int *, unsigned int, unsigned int);
