...
struct format_desc
	...
	int				(*track_read)(union format *, struct container *, struct fifo *, struct fifo *, struct disk_sector *, int);
	int				(*track_write)(union format *, struct fifo *, struct disk_sector *, struct fifo *, unsigned char *, int);
