...
gcr_g64_statistics(
	...
	if (fmt->gcr_g64.rd.flags & FLAG_POSTCOMP_SIMPLE) histogram_postcomp_simple(ffo_l0, fmt->gcr_g64.rw.bnd[speed], 3, track, track);
	return (1);
	}
...
static struct format_option		gcr_g64_rw_options[] =
	{
	FORMAT_OPTION_INTEGER("bounds0",     MAGIC_BOUNDS0_OLD, 9),	/* compat */
	FORMAT_OPTION_INTEGER("bounds1",     MAGIC_BOUNDS1_OLD, 9),	/* compat */
	FORMAT_OPTION_INTEGER("bounds2",     MAGIC_BOUNDS2_OLD, 9),	/* compat */
	FORMAT_OPTION_INTEGER("bounds3",     MAGIC_BOUNDS3_OLD, 9),	/* compat */
