...
extern cw_bool_t			cmdline_parse(cw_char_t **);
extern cw_mode_t			cmdline_get_mode(cw_void_t);
extern cw_bool_t			cmdline_get_flag(cw_flag_t);
extern cw_count_t			cmdline_get_retry(cw_void_t);
extern cw_char_t			*cmdline_get_output(cw_void_t);
extern cw_char_t			*cmdline_get_disk_name(cw_void_t);
extern cw_char_t			*cmdline_get_file(cw_index_t);
extern cw_char_t			**cmdline_get_all_files(cw_void_t);
extern cw_count_t			cmdline_get_files(cw_void_t);
extern cw_bool_t			cmdline_read_config(cw_void_t);
